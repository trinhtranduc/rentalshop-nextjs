# Kế hoạch Google Ads - AnyRent

**Ngân sách:** 50,000 VND/ngày (~1,500,000 VND/tháng)
**Trọng tâm:** Phần mềm cho thuê áo dài, áo cưới, trang phục

---

## Keyword trọng tâm

| Keyword | Volume | Competition | Ghi chú |
|---------|--------|-------------|---------|
| phần mềm cho thuê áo dài | — | Unknown | Chưa đủ data → CPC rẻ, ít cạnh tranh |
| phần mềm cho thuê áo cưới | — | Unknown | Chưa đủ data → CPC rẻ, ít cạnh tranh |
| phần mềm cho thuê trang phục | — | Unknown | Chưa đủ data → cơ hội chiếm TOP |
| phần mềm quản lý cho thuê trang phục | 10 | High (86) | Có volume, competition cao |
| phần mềm cho thuê camera | — | Unknown | Niche mở rộng |

### Keyword hỗ trợ (mở rộng reach)

| Keyword | Volume | Competition | CPC (VND) |
|---------|--------|-------------|-----------|
| phần mềm quản lý cho thuê | 10 | Medium (50) | 2,830 - 8,656 |
| phần mềm quản lý cho thuê nhỏ | 10 | Medium (61) | 3,339 - 19,139 |
| phần mềm cho thuê nhỏ | 10 | Medium (43) | — |
...
| Ad Group | Landing Page | Ghi chú |
|----------|-------------|---------|
| Áo dài / Áo cưới | anyrent.shop/cho-thue-ao-dai hoặc /cho-thue-ao-cuoi | Trang riêng cho niche |
| Trang phục chung | anyrent.shop/cho-thue-trang-phuc | Trang chung |
| Cho thuê chung | anyrent.shop/pricing | Trang pricing |
...
| Clicks | 200 - 400 |
| CTR | 8-15% |
| CPC trung bình | 2,500 - 5,000 VND |
| Conversions (đăng ký) | 10 - 25 |
| Cost/Conversion | 60,000 - 150,000 VND |
...
| Tuần | Action |
|------|--------|
| Tuần 1 | Chạy tất cả keywords, thu thập data |
| Tuần 2 | Pause keywords CPC > 8,000 không convert. Tăng bid cho keyword convert tốt |
| Tuần 3 | Thêm keywords mới từ Search Terms report. Bật remarketing |
| Tuần 4 | Review tổng. Quyết định scale hay optimize tiếp |

---

## Settings quan trọng

- **Vị trí:** Chỉ Việt Nam (ưu tiên HCM, Hà Nội, Đà Nẵng)
- **Giờ chạy:** 7h - 23h (tắt 23h-7h)
- **Thiết bị:** Cả mobile + desktop (monitor CTR theo device)
- **Bidding:** Manual CPC (vì budget nhỏ, cần kiểm soát)
- **Rotation:** Optimize for clicks (tuần đầu), sau đổi Optimize for conversions
- **Conversion tracking:** Setup event đăng ký thành công trên anyrent.shop
