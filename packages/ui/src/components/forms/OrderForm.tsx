      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div>
            ...
            >
              <SelectTrigger>
                <SelectValue placeholder="Chọn khách hàng hoặc để trống cho khách vãng lai" />
              </SelectTrigger>
              <SelectContent>
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => setFormData(prev => ({ 
                    ...prev, 
                    pickupPlanAt: e.target.value ? new Date(e.target.value) : undefined 
                  }))}
                />
              </div>
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => setFormData(prev => ({ 
                    ...prev, 
                    returnPlanAt: e.target.value ? new Date(e.target.value) : undefined 
                  }))}
                />
              </div>
            </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        step="0.01"
                        value={item.deposit}
                        onChange={(e) => updateOrderItem(index, 'deposit', parseFloat(e.target.value) || 0)}
                      />
                    </div>
                  </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <Input
                          type="date"
                          value={item.endDate || ''}
                          onChange={(e) => updateOrderItem(index, 'endDate', e.target.value)}
                        />
                      </div>
                    </div>
                  )}
          ...
          <div className="space-y-4">
            ...
            <div className="border-t pt-4 space-y-2">
              ...
              <div className="flex justify-between text-lg font-semibold border-t pt-2">
                <span>Tổng cộng:</span>
                <span className="text-green-600">{formatCurrency(formData.totalAmount || 0)}</span>
              </div>
              <div className="flex justify-between text-lg font-semibold">
                <span>Tiền cọc:</span>
                <span className="text-blue-600">{formatCurrency(formData.depositAmount || 0)}</span>
              </div>
            </div>
          </div>
        </CardContent>
