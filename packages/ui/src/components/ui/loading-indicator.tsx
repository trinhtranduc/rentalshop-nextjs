...
/**
 * Page-level loading indicator (floating, non-blocking)
 * 
 * Shows a small floating indicator in the top-right corner when page is loading.
 * Perfect for page transitions where you want immediate navigation but show loading state.
 * 
 * Usage:
 * ```tsx
...
export function PageLoadingIndicator({ 
  ...
  return (
    <div 
      className={cn(
        'fixed z-50 bg-white rounded-lg shadow-lg border border-gray-200 px-4 py-2 flex items-center gap-2',
