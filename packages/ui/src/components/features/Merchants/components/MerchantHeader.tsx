      ...
      <Card className="shadow-sm border-gray-200 dark:border-gray-700">
        <CardContent className="p-6">
          <div className="space-y-2">
            ...
            <p className="text-xl font-bold text-gray-900 dark:text-white">{merchant.name}</p>
      ...
      <Card className="shadow-sm border-gray-200 dark:border-gray-700">
        <CardContent className="p-6">
          <div className="text-center">
            ...
            <p className="text-3xl font-bold text-gray-900 dark:text-white">{stats.totalOutlets}</p>
