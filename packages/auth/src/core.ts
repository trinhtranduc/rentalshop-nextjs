...
// Import permissions from client-safe file (no server-only dependencies)
export type { Role, Permission, Resource, UserRole } from './permissions';
...
// Permissions are now imported from ./permissions.ts (client-safe)
