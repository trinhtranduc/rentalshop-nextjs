...
// src/unified-auth.ts
var unified_auth_exports = {};
__export(unified_auth_exports, {
...
module.exports = __toCommonJS(unified_auth_exports);
...
async function authenticateRequest(request) {
  try {
    ...
    try {
      ...
      if (error instanceof import_utils.PlanLimitError) {
        return {
          success: false,
          response: import_server.NextResponse.json(
            {
...
async function checkSubscriptionStatus(user) {
  ...
  const merchant = await import_database.db.merchants.findById(merchantId);
  if (!merchant) {
    return {
      success: false,
      response: import_server2.NextResponse.json(
...
var withAdminAuth = withAuthRoles(["ADMIN"]);
...
var withAuth = withAuthRoles;
var withUserManagementAuth = withManagementAuth;
var withProductManagementAuth = withManagementAuth;
var withOrderManagementAuth = withManagementAuth;
var withOrderViewAuth = withAnyAuth;
var withOrderCreateAuth = withManagementAuth;
var withProductExportAuth = withManagementAuth;
var withCustomerManagementAuth = withManagementAuth;
