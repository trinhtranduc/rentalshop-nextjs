...
export enum ErrorCode {
  ...
  CANNOT_DELETE_NON_CANCELLED_ORDER = 'CANNOT_DELETE_NON_CANCELLED_ORDER',
...
export const ERROR_MESSAGES: Record<ErrorCode, string> = {
  ...
  [ErrorCode.CANNOT_DELETE_NON_CANCELLED_ORDER]: 'Only cancelled orders can be deleted. Please cancel the order first before deleting.',
...
export const ERROR_STATUS_CODES: Record<ErrorCode, number> = {
  ...
  [ErrorCode.CANNOT_DELETE_NON_CANCELLED_ORDER]: 403,
