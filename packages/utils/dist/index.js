...
function isValidErrorCode(code) {
  return Object.values(exports.ErrorCode).includes(code);
}
...
var init_validation = __esm({
  "src/core/validation.ts"() {
    ...
    exports.customersQuerySchema = zod.z.object({
      ...
      merchantId: zod.z.coerce.number().int().positive().optional(),
      // Changed from string to number
      isActive: zod.z.union([zod.z.string(), zod.z.boolean()]).transform((v2) => {
...
var init_react = __esm({
  "../../node_modules/use-intl/dist/esm/production/react.js"() {
    d = React.createContext(void 0);
  }
});

// ../../node_modules/use-intl/dist/esm/production/index.js
...
// ../../node_modules/next-intl/dist/esm/production/index.react-client.js
var init_index_react_client = __esm({
  "../../node_modules/next-intl/dist/esm/production/index.react-client.js"() {
    init_production();
  }
});
...
var init_date = __esm({
  "src/core/date.ts"() {
    ...
    exports.formatDateWithLocale = (date, locale = "en", options = {
      year: "numeric",
      month: "long",
      day: "numeric"
    }) => {
...
function createErrorResponse(error) {
  if (error?.name === "ZodError") {
    return exports.ResponseBuilder.validationError(error.flatten());
  }
  if (error?.code) {
    return exports.ResponseBuilder.error(error.code, error.details);
  }
  const code = getErrorCode(error);
  return exports.ResponseBuilder.error(code, {
    message: error?.message,
...
var ERROR_MESSAGES2, SUCCESS_MESSAGES; exports.ResponseBuilder = void 0;
...
exports.formatChartPeriod = formatChartPeriod;
exports.formatCurrency = formatCurrency;
exports.formatCurrencyAdvanced = formatCurrencyAdvanced;
exports.formatDailyByLocale = formatDailyByLocale;
exports.formatDateByLocale = formatDateByLocale;
exports.formatDateTimeByLocale = formatDateTimeByLocale;
exports.formatFullDateByLocale = formatFullDateByLocale;
exports.formatMonthOnlyByLocale = formatMonthOnlyByLocale;
...
exports.getDisplayErrorKey = getDisplayErrorKey;
exports.getErrorCode = getErrorCode;
exports.getErrorDetails = getErrorDetails;
exports.getErrorStatusCode = getErrorStatusCode;
exports.getErrorTranslationKey = getErrorTranslationKey;
...
exports.hasTranslatableError = hasTranslatableError;
...
exports.useFormattedChartPeriod = useFormattedChartPeriod;
exports.useFormattedDaily = useFormattedDaily;
exports.useFormattedDate = useFormattedDate;
exports.useFormattedDateTime = useFormattedDateTime;
exports.useFormattedFullDate = useFormattedFullDate;
exports.useFormattedMonthOnly = useFormattedMonthOnly;
