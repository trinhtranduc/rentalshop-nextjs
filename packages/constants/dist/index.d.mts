 ...
 */
declare function hasLoyaltyFeature(planFeatures: unknown): boolean;
/**
 * Get plan platform
 */
...
type PricingType = 'FIXED' | 'HOURLY' | 'DAILY' | 'BLOCK';
type PricingUnit = 'DAY' | 'HOUR';
...
declare const PRICING_TYPE_DESCRIPTIONS: {
    ...
    readonly BLOCK: "Price per block of N days (reserved for future use)";
};
/**
