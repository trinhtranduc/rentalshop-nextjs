...
var createErrorResponse = (error, fallbackMessage = "Internal server error") => {
...
var notFound = (resource) => new ApiError(404, `${resource} not found`, "NOT_FOUND");
var badRequest = (message) => new ApiError(400, message, "BAD_REQUEST");
var unauthorized = () => new ApiError(401, "Unauthorized", "UNAUTHORIZED");
var forbidden = () => new ApiError(403, "Forbidden", "FORBIDDEN");
export {
  ApiError,
  badRequest,
  createErrorResponse,
