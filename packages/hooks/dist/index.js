        ...
        const e3 = M3.format(u2 ? function(e4) {
          ...
          return Object.keys(e4).forEach((o5) => {
            ...
            i3 = "function" == typeof s2 ? (e5) => {
              const n6 = s2(e5);
              return (0, import_react12.isValidElement)(n6) ? (0, import_react12.cloneElement)(n6, { key: o5 + a3++ }) : n6;
            } : s2, n5[o5] = i3;
          }), n5;
        }(u2) : u2);
        if (null == e3)
          throw new Error(void 0);
        return (0, import_react12.isValidElement)(e3) || Array.isArray(e3) || "string" == typeof e3 ? e3 : String(e3);
      } catch (e3) {
...
var d2 = (0, import_react13.createContext)(void 0);
function v() {
  const e3 = (0, import_react13.useContext)(d2);
  if (!e3)
    throw new Error(void 0);
  return e3;
}
