    ...
    schemas: {
      Order: {
        ...
        properties: {
          ...
          customerPhone: { type: 'string', nullable: true, description: 'Customer phone number' },
          customerEmail: { type: 'string', nullable: true, description: 'Customer email address' },
          merchantId: { type: 'number', nullable: true, description: 'Merchant ID' },
          merchantName: { type: 'string', nullable: true, description: 'Merchant name' },
