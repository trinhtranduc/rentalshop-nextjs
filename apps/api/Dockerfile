...
# Install OpenSSL for Prisma (required for debian-openssl-3.0.x binary)
RUN apk add --no-cache openssl
...
# Start Next.js server (normal mode, not standalone)
