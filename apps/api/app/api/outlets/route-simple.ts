 ...
 * REFACTORED: Now uses unified withAuth pattern
 */
export const POST = withAuth(['ADMIN', 'MERCHANT'])(async (request, { user, userScope }) => {
 ...
 * REFACTORED: Now uses unified withAuth pattern
 */
export const PUT = withAuth(['ADMIN', 'MERCHANT'])(async (request, { user, userScope }) => {
 ...
 * REFACTORED: Now uses unified withAuth pattern
 */
export const DELETE = withAuth(['ADMIN', 'MERCHANT'])(async (request, { user, userScope }) => {
