...
export async function generateMetadata(): Promise<Metadata> {
  ...
  if (locale === 'vi') {
    return {
      ...
      keywords: [
        // Primary keywords - áo dài rental (ứng dụng + phần mềm)
        'ứng dụng quản lý cửa hàng cho thuê áo dài',
        'phần mềm quản lý cửa hàng cho thuê áo dài',
        'app quản lý cửa hàng cho thuê áo dài',
        'ứng dụng quản lý shop áo dài',
        'phần mềm quản lý shop áo dài',
        'app quản lý shop áo dài',
        'ứng dụng quản lý shop cho thuê áo dài',
        'phần mềm quản lý shop cho thuê áo dài',
        'ứng dụng quản lý cho thuê áo dài',
        'phần mềm quản lý cho thuê áo dài',
        'app quản lý cho thuê áo dài',
        'ứng dụng quản lý cho thuê áo dài online',
        'phần mềm quản lý cho thuê áo dài online',
        'hệ thống quản lý cửa hàng cho thuê áo dài',
        'quản lý cửa hàng cho thuê áo dài',
        'quản lý shop áo dài',
        'quản lý cho thuê áo dài',
        'software quản lý cho thuê áo dài',
        // Primary keywords - áo cưới rental (ứng dụng + phần mềm)
        'ứng dụng quản lý cửa hàng cho thuê áo cưới',
        'phần mềm quản lý cửa hàng cho thuê áo cưới',
        'app quản lý cửa hàng cho thuê áo cưới',
        'ứng dụng quản lý shop áo cưới',
        'phần mềm quản lý shop áo cưới',
        'app quản lý shop áo cưới',
        'ứng dụng quản lý cho thuê áo cưới',
        'phần mềm quản lý cho thuê áo cưới',
        'app quản lý cho thuê áo cưới',
        'hệ thống quản lý cửa hàng cho thuê áo cưới',
        'quản lý cửa hàng cho thuê áo cưới',
        'quản lý shop áo cưới',
        'quản lý cho thuê áo cưới',
        'software quản lý cho thuê áo cưới',
        // Primary keywords - general áo rental (ứng dụng + phần mềm)
        'ứng dụng quản lý cửa hàng cho thuê áo',
        'phần mềm quản lý cửa hàng cho thuê áo',
        'app quản lý cửa hàng cho thuê áo',
        'ứng dụng quản lý shop cho thuê áo',
        'phần mềm quản lý shop cho thuê áo',
        'app quản lý shop cho thuê áo',
        'ứng dụng quản lý cho thuê áo',
        'phần mềm quản lý cho thuê áo',
        'app quản lý cho thuê áo',
        'hệ thống quản lý cửa hàng cho thuê áo',
        'quản lý cửa hàng cho thuê áo',
        'quản lý shop cho thuê áo',
        'quản lý cho thuê áo',
        // General rental management keywords (ứng dụng + phần mềm)
        'ứng dụng quản lý cửa hàng cho thuê',
        ...
        'phần mềm cho thuê',
        'app cho thuê',
        // Long-tail keywords (ứng dụng + phần mềm)
        'ứng dụng quản lý tiệm cho thuê áo dài',
        'phần mềm quản lý tiệm cho thuê áo dài',
        'app quản lý tiệm cho thuê áo dài',
        'ứng dụng quản lý tiệm cho thuê áo cưới',
        'phần mềm quản lý tiệm cho thuê áo cưới',
        'app quản lý tiệm cho thuê áo cưới',
        'ứng dụng quản lý cửa hàng áo dài',
        'phần mềm quản lý cửa hàng áo dài',
        'app quản lý cửa hàng áo dài',
        'ứng dụng quản lý cửa hàng áo cưới',
        'phần mềm quản lý cửa hàng áo cưới',
        'app quản lý cửa hàng áo cưới',
        'ứng dụng quản lý kho áo dài',
        'phần mềm quản lý kho áo dài',
        'app quản lý kho áo dài',
        'ứng dụng quản lý kho áo cưới',
        'phần mềm quản lý kho áo cưới',
        'app quản lý kho áo cưới',
        // Other rental types (for broader SEO - ứng dụng + phần mềm)
        'ứng dụng quản lý cho thuê trang thiết bị',
        'phần mềm quản lý cho thuê trang thiết bị',
        'app quản lý cho thuê trang thiết bị',
        'ứng dụng quản lý cho thuê xe',
        'phần mềm quản lý cho thuê xe',
        'app quản lý cho thuê xe',
        'ứng dụng quản lý cho thuê trang phục biểu diễn',
        'phần mềm quản lý cho thuê trang phục biểu diễn',
        'app quản lý cho thuê trang phục biểu diễn',
        'ứng dụng quản lý cho thuê máy in',
        'phần mềm quản lý cho thuê máy in',
        'app quản lý cho thuê máy in',
